...
#if BABEL
     internal sealed partial class $parserName$Scanner : ScanBase, IColorScan
    {
...
#else  // BABEL
	internal sealed partial class $parserName$Scanner : ScanBase
	{
		private ScanBuff buffer;
		int currentScOrd;  // start condition ordinal
#endif // BABEL
...
#if !NOFILES
		internal $parserName$Scanner(Stream file)
		{
			SetSource(file); // no unicode option
		}
#endif // !NOFILES

		internal $parserName$Scanner() { }
